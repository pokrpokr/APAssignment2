/*
  This file for creating tables of unilink system
 */
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try (Connection con = connectionTest.getConnection(DB_NAME);
            ...
            int c_result_3 = stmt.executeUpdate("CREATE TABLE posts("
                    + "id INTEGER GENERATED BY DEFAULT AS IDENTITY,"
                    + "creatorId INTEGER NOT NULL,"
                    + "idStr VARCHAR(50) UNIQUE NOT NULL,"
                    + "creatorName VARCHAR(255) NOT NULL,"
            ...
            int add_index = stmt.executeUpdate("CREATE INDEX UID ON posts (creatorId, idStr)");
            if (add_index == 0){
